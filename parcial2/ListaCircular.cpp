...
public:
    ...
    void agregarInicio(T valor) {
        ...
        // ligar ultimo con este LISTO

        auto actual = cabeza;
        while(actual->siguiente->siguiente != nullptr && !(actual->siguiente->siguiente->flag)) {
            actual = actual->siguiente;
        }
        auto penultimo = actual;

        penultimo->siguiente->siguiente = cabeza;
    ...
    void agregarFin(T valor) {
        ...
        auto actual = cabeza;
        while(actual->siguiente != nullptr && !(actual->flag)) {
            actual = actual->siguiente;
        }
